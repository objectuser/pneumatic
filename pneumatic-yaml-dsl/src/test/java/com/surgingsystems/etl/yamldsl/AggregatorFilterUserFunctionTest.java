...
@ContextConfiguration({ "classpath:etl-context.xml", "classpath:aggregator-user-function-def.xml" })
@DirtiesContext(classMode = ClassMode.AFTER_EACH_TEST_METHOD)
public class AggregatorFilterUserFunctionTest {
    ...
    public void parseFile() {
        yamlParser.parse("aggregator-user-function-test.yml");
