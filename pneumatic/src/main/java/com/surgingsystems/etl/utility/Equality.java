...
public class Equality {
     ...
     */
    @SuppressWarnings("unchecked")
    public static <T> T applicable(Class<T> targetClass, T o1, Object o2) {
        if (o2 == null || o1.hashCode() != o2.hashCode() || !targetClass.isAssignableFrom(o1.getClass())
                || !targetClass.isAssignableFrom(o2.getClass())) {
            return null;
        } else {
            return (T) o2;
        }
