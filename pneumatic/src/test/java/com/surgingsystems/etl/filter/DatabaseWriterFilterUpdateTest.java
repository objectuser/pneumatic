...
@ContextConfiguration({ "classpath:etl-context.xml", "database-writer-filter-update-test.xml" })
@DirtiesContext(classMode = ClassMode.AFTER_EACH_TEST_METHOD)
public class DatabaseWriterFilterUpdateTest {
    ...
    public void update() {
        ...
        List<Record> records = jdbcTemplate.query("select * from mtb", new RowMapper<Record>() {
